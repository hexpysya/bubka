...
## `<span style="color:red">`Traffic Analysis
...
I filtered HTTP traffic and observed the attacker (192.168.170.128) testing PHP command execution with `<?php system('****');?>` payloads for reconnaissance.The attacker used to doawnload a `nc64.exe`, but it was a just a html form.
![alt text](image.png)

At `2025-01-22 09:47:32`, the attacker exploited a `<span style="color:red">`CVE-2024-4577 to gain a Reverse Shell to **192.168.170.128** on `<span style="color:red">`4545/tcp
...
*Reverse Shell:* `192.168.170.128:4545`
